/**
 * @author harkiranmahun
 * @version 1.0
 * Class Description: Server class with extending JavaFx Application class
 */
...
public class ChatServer extends Application {
	...
	public void start(Stage stage) {
		...
		// configure the visual components of JavaFx
	...
	private void getInfo() {
		...
		alert.setHeaderText ("Press OK to start server. The dialogue window will appear when a client connects."); alert.showAndWait();
	}
